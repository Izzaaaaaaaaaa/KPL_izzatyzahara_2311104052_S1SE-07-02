...
namespace modul7_kelompok_5
{
    ...
    public class GlossaryItem2311104052
    {
        public Glossary glossary { get; set; }

        public void ReadJSON()
        {
            string jsonString = File.ReadAllText("jurnal7_3_2311104052.json");
            GlossaryItem2311104052 glossaryItem = JsonSerializer.Deserialize<GlossaryItem2311104052>(jsonString);
