...
namespace modul7_kelompok_5;
    ...
    public class TeamMembers2311104052
    {
        ...
        public void ReadJSON()
        {
            try
            {
                string jsonString = File.ReadAllText("jurnal7_2_2311104052.json");

                TeamMembers2311104052 team = JsonSerializer.Deserialize<TeamMembers2311104052>(jsonString);
