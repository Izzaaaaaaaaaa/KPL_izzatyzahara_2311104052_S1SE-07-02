...
namespace modul7_kelompok_5
{
    ...
    public class DataMahasiswa2311104052
    {
        ...
        {
            string fileName = "jurnal7_1_2311104052.json";
            ...
            var mahasiswa = JsonSerializer.Deserialize<DataMahasiswa2311104052>(jsonString);
